function [L, x, y, Z_L, Z_V, rhoL, rhoV, reports] = eCPAstandaloneFlash(p, T, z, EOSModel, varargin)
% Utility for flashing without explicitly forming a state
% Wei Xiong edit on 19.01.2023

% SYNOPSIS:
%   [L, x, y, Z_L, Z_V] = eCPAstandaloneFlash(p, T, z, pcap, wetAng, rp, EOSModel)
%
% DESCRIPTION:
