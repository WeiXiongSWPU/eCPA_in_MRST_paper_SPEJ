...
eCPAmixture = ECPATableCompositionalMixture({'Water', 'CarbonDioxide'},{'Water', 'CO2'});
...
% boundaries
p = 50*barsa; T = 273.15 + 30; s = []; z = [0.95, 0.05];     % p, T, z, s
...
eCPAstate0 = eCPAinitCompositionalState(eCPAoverall, p, T, s, z);
