classdef ECPAGenericOverallCompositionModel < ECPAOverallCompositionCompositionalModel & GenericReservoirModel
    properties
        
    end
    
    methods
        function model = ECPAGenericOverallCompositionModel(varargin)
            model = model@ECPAOverallCompositionCompositionalModel(varargin{:});
        ...
        function [state, report] = updateState(model, state, problem, dx, forces)
            ...
            [state, report] = updateState@ECPAOverallCompositionCompositionalModel(model, state, problem, dx, forces);
        ...
        function model = validateModel(model, varargin)
            ...
            model = validateModel@ECPAOverallCompositionCompositionalModel(model, varargin{:});
        end
        
        function model = setupStateFunctionGroupings(model, varargin)
            model = setupStateFunctionGroupings@ECPAOverallCompositionCompositionalModel(model, varargin{:});
        ...
        function forces = validateDrivingForces(model, forces, varargin)
            forces = validateDrivingForces@ECPAOverallCompositionCompositionalModel(model, forces, varargin{:});
