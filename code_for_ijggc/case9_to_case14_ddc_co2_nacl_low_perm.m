...
rng(0);
K = 0.1*ones(n_x*n_z,1);
K = K + 0.01.*(2.*rand(n_x*n_z,1)-1).*K;
rock = makeRock(G, K*darcy, 0.2);
...
z1 = [0.963,0.019,0.009,0.009]; z2 = [0.982,0,0.009,0.009];
% z1 = [0.9472,0.0168,0.018,0.018]; z2 = [0.964,0,0.018,0.018];
% z1 = [0.9312,0.0148,0.027,0.027]; z2 = [0.946,0,0.027,0.027];
% z1 = [0.915,0.013,0.036,0.036]; z2 = [0.928,0,0.036,0.036];
% z1 = [0.8983,0.0117,0.045,0.045]; z2 = [0.91,0,0.045,0.045];
% z1 = [0.8816,0.0104,0.054,0.054]; z2 = [0.892,0,0.054,0.054];
...
dt = rampupTimesteps(100*year, 10*day, 10);
