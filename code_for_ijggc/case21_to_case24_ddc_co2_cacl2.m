...
mixture = ECPATableCompositionalMixture({'Water','Carbondioxide','Ca2+','Cl-'});
...
z1 = [0.9567,0.0163,0.009,0.018]; z2 = [0.973,0,0.009,0.018];
% z1 = [0.9336,0.0124,0.018,0.036]; z2 = [0.946,0,0.018,0.036];
% z1 = [0.9091,0.0099,0.027,0.054]; z2 = [0.919,0,0.027,0.054];
% z1 = [0.8842,0.0078,0.036,0.072]; z2 = [0.892,0,0.036,0.072];
